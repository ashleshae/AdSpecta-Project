...
//           <a href="/">Home</a>
//           <span>→</span>
//           <Link to="/browse-hoarding" style={{ cursor: "pointer" }}>
//             Billboard
//           </Link>
//           <span>→</span>
//         </div>
//       </div>
//       <h1 className="details-heading">Advertising on Hoarding in Mumbai 16042</h1>

//       <div className="details-top-section">
//         <img
//           src="https://via.placeholder.com/400x250" // Replace with real image
//           alt="Hoarding"
...
//             <div className="details-info-item">
//               <h4>NON LIT</h4>
//               <span className="details-info-label">LIGHTING</span>
//             </div>
//           </div>

//           <div className="details-description">
//             <h3>About Advertising on Hoarding in Mumbai 16042</h3>
//             <p>
//               Hoardings in Mumbai improve long-term brand recall and offer wide
//               reach. They are typically found in hyperlocal areas with large crowds
//               which offer high visibility to passersby, pedestrians, and commuters.
//               As people quickly notice them, Hoardings attract potential customers
//               and maintain brand awareness. Hoarding Ads are generally used to
//               showcase new products/services/offers.
//             </p>
//           </div>
//         </div>
//       </div>
...
//           </div>
//           <div className="details-insight-item">
//             <span className="details-insight-label">ID</span>
//             <h4>16042</h4>
//           </div>
//           {/* <div className="details-insight-item">
//             <span className="details-insight-label">TOTAL IMPRESSIONS</span>
//             <h4>5.7M</h4>
//           </div> */}
//           <div className="details-insight-item">
//             <span className="details-insight-label">QUANTITY</span>
//             <h4>1</h4>
//           </div>
